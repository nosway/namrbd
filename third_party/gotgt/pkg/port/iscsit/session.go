...
var sessionKeys map[string]*iscsiSessionKeys = map[string]*iscsiSessionKeys{
	...
	// ISCSI_PARAM_PDU_INORDER_EN
	"DataPDUInOrder": {ISCSI_PARAM_PDU_INORDER_EN, true, 1, 0, 1, boolKeyConv, boolKeyInConv},
	// ISCSI_PARAM_DATASEQ_INORDER_EN
	"DataSequenceInOrder": {ISCSI_PARAM_DATASEQ_INORDER_EN, true, 1, 0, 1, boolKeyConv, boolKeyInConv},
	// ISCSI_PARAM_ERL
