...
type BackendStorage struct {
	...
	SCSIVendorID     string `json:"scsiVendorID,omitempty"`
	SCSIProductID    string `json:"scsiProductID,omitempty"`
	SCSIProductRev   string `json:"scsiProductRev,omitempty"`
	SCSIID           string `json:"scsiID,omitempty"`
	SCSISerial       string `json:"scsiSerial,omitempty"`
}
...
type ISCSITarget struct {
	...
	TPGTALUA map[string]ALUATargetPortGroup `json:"tpgtAlua,omitempty"`
	LUNs     map[string]uint64              `json:"luns"`
}

type ALUATargetPortGroup struct {
	AccessState       uint8 `json:"accessState,omitempty"`
	Preferred         bool  `json:"preferred,omitempty"`
	ImplicitSupported bool  `json:"implicitSupported,omitempty"`
	ExplicitSupported bool  `json:"explicitSupported,omitempty"`
}
