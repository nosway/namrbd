...
set_args=(
	...
	--set "edition=${NAMRBD_CSI_EDITION:-community}"
	--set "image.repository=${CSI_DRIVER_IMAGE_REPOSITORY:-ghcr.io/nosway/namrbd-csi-driver}"
	--set "image.tag=${CSI_DRIVER_IMAGE_TAG:-v1.0.0}"
	--set "image.digest=${CSI_DRIVER_IMAGE_DIGEST:-sha256:e6a1e2111f896a54b725bb8f28e19461ad27bd8786d1f682d6ba1b34470fb958}"
	...
	--set "storageClasses.ec63.create=${CSI_EC_STORAGECLASS_ENABLED:-false}"
